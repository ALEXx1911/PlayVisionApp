...
class TestTeamAPI:
    def test_team_details_success(self, api_client, team_factory, season_factory):
        ...
        team_response = api_client.get(f"{url}?season={season.year_start}")
    ...
    def test_team_details_include_insights(self, api_client, team_factory, season_factory , team_insights_factory):
        team = team_factory(title = "Test Team", slug = "test-team")
        season = season_factory(year_start="2024", year_end="2025")
    ...
    def test_team_details_include_matches(self, api_client, team_factory, season_factory, competition_factory, match_factory):
        team = team_factory(title = "Test Team", slug = "test-team")
        season = season_factory(year_start="2024", year_end="2025")
    ...
    def test_team_details_include_player_stats(self, api_client, team_factory, season_factory,
        player_factory, player_season_stats_factory):
        team = team_factory(title = "Test Team", slug = "test-team")
        season = season_factory(year_start="2024", year_end="2025")
    ...
    def test_team_details_not_found(self, api_client):
        ...
        team_response = api_client.get(url)
